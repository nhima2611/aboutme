  ...
  return (
    <div className='flex flex-col-reverse  h-full items-center  '>
        <div className='px-5 flex flex-col py-14  '>
            ...
            <button onClick={() =>navigate( "/about")} className='flex justify-center items-center mt-8 gap-4 border-2 w-[200px] mx-auto  py-2 text-gray-500 hover:shadow-md mb-8'>View more <BsArrowRight/> </button>
        </div>
        <div>
            <img src={hero} alt="" />
        </div>
